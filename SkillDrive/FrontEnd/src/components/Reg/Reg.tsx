...
function Reg() {
  ...
  const toggleErrorBar = (isError: boolean): void => {
  ...
  return (
    <>
      <Header />
      <NoScript />
      <div className={`reg__form-error ${errorBarIsActive ? "is-active" : ""}`}>Не удалось продолжить регистрацию. Попробуйте ещё раз.</div>
